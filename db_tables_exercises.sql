...
-- salaries for sure and maybe all have an id number column, unless they use char for id
...
-- dept_no and emp_no are used in the dept_emp and dept_manager tables
